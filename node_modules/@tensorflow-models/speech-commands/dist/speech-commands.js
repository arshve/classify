    ...
    ***************************************************************************** */
                ...
                return [2, new Promise(function (resolve, reject) {
                        ...
                        if (url.indexOf(HTTP_SCHEME) === 0 ||
                            ...
                            fetch(url).then(function (response) {
                                response.json().then(function (parsed) { return resolve(parsed); });
                            });
                        }
                        else if (url.indexOf(FILE_SCHEME) === 0) {
                            var fs = require('fs');
                            fs.readFile(url.slice(FILE_SCHEME.length), { encoding: 'utf-8' }, function (err, data) { return resolve(JSON.parse(data)); });
                        }
                        else {
                            reject(new Error("Unsupported URL scheme in metadata URL: " + url + ". " +
    ...
    function getAudioMediaStream(audioTrackConstraints) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, navigator.mediaDevices.getUserMedia({
        ...
        Dataset.prototype.getData = function (label, config) {
            ...
            return tf.tidy(function () {
                ...
                if (config.augmentByMixingNoiseRatio != null) {
                    _this.augmentByMixingNoise(config.getDataset ? xArrays : xTensors, labelIndices, config.augmentByMixingNoiseRatio);
                }
        ...
        Dataset.prototype.augmentByMixingNoise = function (xs, labelIndices, ratio) {
            ...
            var _loop_3 = function (index) {
                ...
                var signalTensor = isTypedArray ?
                    tf.tensor1d(xs[index]) : xs[index];
                var noiseTensor = isTypedArray ?
                    tf.tensor1d(xs[noiseIndex]) :
                    xs[noiseIndex];
                var mixed = tf.tidy(function () {
                    return normalize(signalTensor.add(noiseTensor.mul(ratio)));
                });
                if (isTypedArray) {
    ...
    var BrowserFftSpeechCommandRecognizer = (function () {
        function BrowserFftSpeechCommandRecognizer(vocabulary, modelURL, metadataURL) {
            ...
            tf.util.assert(modelURL == null && metadataURL == null ||
                modelURL != null && metadataURL != null, function () { return "modelURL and metadataURL must be both provided or " +
                "both not provided."; });
            if (modelURL == null) {
                if (vocabulary == null) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [4, tf.loadLayersModel(this.modelURL)];
                        case 2:
                            model = _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!(this.dataset.durationMillis() > datasetDurationMillisThreshold)) return [3, 2];
                            ...
                            return [4, this.trainOnDataset(config)];
                        case 1: return [2, _a.sent()];
                        case 2: return [4, this.trainOnTensors(config)];
    ...
    function create(fftType, vocabulary, customModelURL, customMetadataURL) {
        tf.util.assert(customModelURL == null && customMetadataURL == null ||
            customModelURL != null && customMetadataURL != null, function () { return "customModelURL and customMetadataURL must be both provided or " +
            "both not provided."; });
