...
(function (global, factory) {
    ...
    (factory((global.bodyPix = {}),global.tf));
    ...
    ***************************************************************************** */
    ...
    function resizeAndPadTo(input, _a, flipHorizontal) {
    ...
    var BodyPix = (function () {
        ...
        BodyPix.prototype.estimatePersonSegmentation = function (input, outputStride, segmentationThreshold) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                var _a, height, width, segmentation, result;
                var _this = this;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            segmentation = tf.tidy(function () {
                                var _a = resizeAndPadTo(input, segmentationModelImageDimensions), resizedAndPadded = _a.resizedAndPadded, paddedBy = _a.paddedBy;
        ...
        BodyPix.prototype.estimatePartSegmentation = function (input, outputStride, segmentationThreshold) {
            ...
            if (segmentationThreshold === void 0) { segmentationThreshold = 0.5; }
            return __awaiter(this, void 0, void 0, function () {
                var _a, height, width, partSegmentation, data;
                var _this = this;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            assertValidOutputStride(outputStride);
                            _a = getInputTensorDimensions(input), height = _a[0], width = _a[1];
                            partSegmentation = tf.tidy(function () {
                                var _a = resizeAndPadTo(input, segmentationModelImageDimensions), resizedAndPadded = _a.resizedAndPadded, paddedBy = _a.paddedBy;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, tf.loadGraphModel(baseUrl + "model.json")];
                    case 1:
                        model = _a.sent();
