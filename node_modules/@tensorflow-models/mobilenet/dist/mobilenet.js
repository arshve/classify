    ...
    ***************************************************************************** */
    ...
    function load(version, alpha) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var versionStr, alphaStr, mobilenet;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        versionStr = version.toFixed(2);
                        alphaStr = alpha.toFixed(2);
                        ...
                        if (!(alphaStr in MODEL_INFO[versionStr])) {
                            throw new Error("MobileNet constructed with invalid alpha " + alpha + ". Valid " +
    ...
    var MobileNet = (function () {
        ...
        MobileNet.prototype.infer = function (img, embedding) {
            var _this = this;
